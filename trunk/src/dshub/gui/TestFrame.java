...
public class TestFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jPanel1.add(jLabel44,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 270, -1,
						-1));

		jPanel23.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Death Squad Hub. The Credits"));
		...
		jLabel69
				.setText("there for me, also to everybody using my software and");
		...
		jLabel61
				.setText("Many thanks to all the people who helped in translating.");
				...
				.setVerticalGroup(jPanel23Layout
						...
						.add(
								jPanel23Layout
										...
										.addPreferredGap(
												org.jdesktop.layout.LayoutStyle.RELATED)
										.add(jLabel61).addContainerGap(42,
												Short.MAX_VALUE)));

		jPanel1.add(jPanel23,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 330,
						240));

		jPanel24.setBorder(javax.swing.BorderFactory
				.createTitledBorder("License"));

		jLabel1
				.setText("This program is distributed in the hope that it will be useful, ");

		jLabel2
				.setText("but WITHOUT ANY WARRANTY; without even the implied warranty of ");

		jLabel3
				.setText("MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See");

		jLabel4.setText("the GNU General Public License for more details. ");

		jLabel66
				.setText("This program uses the MINA library http://mina.apache.org licensed");

		jLabel9.setText("under the Apache Public License.");

		jLabel65
				.setText("This program uses the Jython library http://jython.sf.net licensed");
		...
		jPanel24Layout.setHorizontalGroup(jPanel24Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel24Layout.createSequentialGroup().add(
						jPanel24Layout.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING).add(
								jLabel1).add(jLabel2).add(
								org.jdesktop.layout.GroupLayout.TRAILING,
								jLabel3,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								368, Short.MAX_VALUE).add(jLabel4)
								.add(jLabel66).add(jLabel9).add(jLabel65).add(
										jLabel71)).addContainerGap()));
		jPanel24Layout
				.setVerticalGroup(jPanel24Layout
						...
						.add(
								jPanel24Layout
										...
										.addPreferredGap(
												org.jdesktop.layout.LayoutStyle.RELATED)
										.add(jLabel71).addContainerGap(49,
												Short.MAX_VALUE)));

		jPanel1.add(jPanel24,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 10, 390,
						240));
		...
		jPanel7.add(jButton7,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 160, -1,
						-1));

		jPanel20.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Hub Settings"));
		...
		regonlycheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
		...
		jPanel20Layout.setVerticalGroup(jPanel20Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel20Layout.createSequentialGroup().add(
						...
						jPanel20Layout.createParallelGroup(
								...
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.add(jLabel18)).addPreferredGap(
						org.jdesktop.layout.LayoutStyle.RELATED).add(
						regonlycheck).addContainerGap(
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE)));

		jPanel7.add(jPanel20,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 470,
						90));
		...
		proxycheck
				.setText("Use Proxy for http access required by some modules");
		proxycheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		...
		portlist.setModel(new javax.swing.table.DefaultTableModel(
				...
				}, new String[] { "Value", "Status", "Message" }) {
		...
		jPanel7.add(jPanel21,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 470,
						260));
		...
		jLabel20
				.setText("Number of seconds for hub to wait for connecting users until kick them out, Integer");
				...
				.setVerticalGroup(jPanel13Layout
						...
						.add(
								jPanel13Layout
										...
										.addPreferredGap(
												org.jdesktop.layout.LayoutStyle.RELATED,
												110, Short.MAX_VALUE).add(
												jButton9).add(69, 69, 69)));
		...
		jLabel15
				.setText("Interval between automagic searches for each user, seconds, Integer.");

		searchlogbasefield.setText("2000");

		jLabel16.setFont(new java.awt.Font("Tahoma", 0, 10));
		jLabel16
				.setText("Logarithmic base for user searches interval,millis, Integer.");

		searchstepsfield.setText("6");

		jLabel45.setFont(new java.awt.Font("Tahoma", 0, 10));
		jLabel45
				.setText("Maximum nr of search steps allowed until reset needed, Integer.");

		searchspamresetfield.setText("300");

		jLabel46.setFont(new java.awt.Font("Tahoma", 0, 10));
		jLabel46
				.setText("Interval until search_steps is being reset, seconds, Integer.");
		...
		jLabel47
				.setText("Message that appears as a result when search is delayed, String.");
		...
		org.jdesktop.layout.GroupLayout xxxLayout = new org.jdesktop.layout.GroupLayout(
				xxx);
		xxx.setLayout(xxxLayout);
		xxxLayout
				.setHorizontalGroup(xxxLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(
								xxxLayout
		...
		xxxLayout.setVerticalGroup(xxxLayout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				xxxLayout.createSequentialGroup().addContainerGap().add(
						xxxLayout.createParallelGroup(
								org.jdesktop.layout.GroupLayout.BASELINE).add(
								maxchatmsgfield,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.add(jLabel38)).addPreferredGap(
						org.jdesktop.layout.LayoutStyle.RELATED).add(
						xxxLayout.createParallelGroup(
								org.jdesktop.layout.GroupLayout.BASELINE).add(
								chatintervalfield,
						...
						xxxLayout.createParallelGroup(
								...
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.add(jLabel16)).addPreferredGap(
						org.jdesktop.layout.LayoutStyle.RELATED).add(
						xxxLayout.createParallelGroup(
								org.jdesktop.layout.GroupLayout.BASELINE).add(
								jLabel45).add(searchstepsfield,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.add(jButton5)).add(9, 9, 9).add(
						xxxLayout.createParallelGroup(
								org.jdesktop.layout.GroupLayout.BASELINE).add(
								searchspamresetfield,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
		...
		miscpanel.add(jButton11,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 160, -1,
						-1));

		jPanel35.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Bots settings"));
		...
		org.jdesktop.layout.GroupLayout jPanel35Layout = new org.jdesktop.layout.GroupLayout(
				jPanel35);
		...
		jPanel35Layout.setVerticalGroup(jPanel35Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel35Layout.createSequentialGroup().add(
						...
						jPanel35Layout.createParallelGroup(
								...
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.add(jLabel49)).addContainerGap(16,
						Short.MAX_VALUE)));

		miscpanel.add(jPanel35,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 480,
						150));

		jPanel36.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Redirects"));
		...
		jLabel53
				.setText("The main redirect URL to send faulty users ( or default redirects )");

		org.jdesktop.layout.GroupLayout jPanel36Layout = new org.jdesktop.layout.GroupLayout(
				jPanel36);
		jPanel36.setLayout(jPanel36Layout);
		jPanel36Layout.setHorizontalGroup(jPanel36Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel36Layout.createSequentialGroup().add(10, 10, 10).add(
						redirecturl,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).add(18,
						18, 18).add(jLabel53).addContainerGap(
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE)));
		jPanel36Layout.setVerticalGroup(jPanel36Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel36Layout.createSequentialGroup().add(
						jPanel36Layout.createParallelGroup(
								...
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.add(jLabel53)).addContainerGap(
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE)));

		miscpanel.add(jPanel36,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 480,
						50));

		jPanel38.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Kick settings"));
		...
		org.jdesktop.layout.GroupLayout jPanel38Layout = new org.jdesktop.layout.GroupLayout(
				jPanel38);
		jPanel38.setLayout(jPanel38Layout);
		jPanel38Layout.setHorizontalGroup(jPanel38Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel38Layout.createSequentialGroup().addContainerGap().add(
						kicktimefield,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).add(18,
						18, 18).add(jLabel40).addContainerGap(92,
						Short.MAX_VALUE)));
		jPanel38Layout.setVerticalGroup(jPanel38Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel38Layout.createSequentialGroup().add(
						jPanel38Layout.createParallelGroup(
								...
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.add(jLabel40)).addContainerGap(14,
						Short.MAX_VALUE)));

		miscpanel.add(jPanel38,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 480,
						60));

		jPanel39.setBorder(javax.swing.BorderFactory
				.createTitledBorder("History settings"));
		...
		jLabel39
				.setText("Number of lines to keep in chat and command history.");

		org.jdesktop.layout.GroupLayout jPanel39Layout = new org.jdesktop.layout.GroupLayout(
				jPanel39);
		jPanel39.setLayout(jPanel39Layout);
		jPanel39Layout.setHorizontalGroup(jPanel39Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel39Layout.createSequentialGroup().addContainerGap().add(
						historylinesfield,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).add(18,
						18, 18).add(jLabel39).addContainerGap(56,
						Short.MAX_VALUE)));
		jPanel39Layout.setVerticalGroup(jPanel39Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel39Layout.createSequentialGroup().add(
						jPanel39Layout.createParallelGroup(
								...
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.add(jLabel39)).addContainerGap(14,
						Short.MAX_VALUE)));

		miscpanel.add(jPanel39,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 300, 480,
						60));
		...
		jLabel42
				.setText("The additional message to be shown to connecting users when hub full.");
		...
		jLabel41
				.setText("The aditional message to show to banned users when connecting.");

		msgbannedfield.setColumns(20);
		msgbannedfield.setRows(5);
		jScrollPane5.setViewportView(msgbannedfield);

		org.jdesktop.layout.GroupLayout jPanel34Layout = new org.jdesktop.layout.GroupLayout(
				jPanel34);
		jPanel34.setLayout(jPanel34Layout);
		jPanel34Layout.setHorizontalGroup(jPanel34Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel34Layout.createSequentialGroup().addContainerGap().add(
						jPanel34Layout.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING).add(
								jScrollPane6,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								568, Short.MAX_VALUE).add(jLabel42).add(
								jLabel41).add(jScrollPane5,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								568, Short.MAX_VALUE)).addContainerGap()));
		jPanel34Layout.setVerticalGroup(jPanel34Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel34Layout.createSequentialGroup().add(jLabel42)
						.addPreferredGap(
								org.jdesktop.layout.LayoutStyle.RELATED).add(
								jScrollPane6,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
		...
		jPanel37.add(jPanel34,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 600,
						250));
		...
		jPanel37.add(jButton31,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 340, -1,
						-1));

		jPanel40.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Logging settings"));

		savelogscheck.setFont(new java.awt.Font("Tahoma", 0, 10));
		savelogscheck.setText("Save logs to file.");
		savelogscheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
		...
		jLabel56
				.setText("Logs have their file name the date when hub was started.");

		jLabel57.setFont(new java.awt.Font("Tahoma", 0, 10));
		jLabel57.setText("They are saved to /logs directory.");

		org.jdesktop.layout.GroupLayout jPanel40Layout = new org.jdesktop.layout.GroupLayout(
				jPanel40);
		jPanel40.setLayout(jPanel40Layout);
		jPanel40Layout.setHorizontalGroup(jPanel40Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel40Layout.createSequentialGroup().addContainerGap().add(
						savelogscheck).addPreferredGap(
						org.jdesktop.layout.LayoutStyle.UNRELATED).add(
						jPanel40Layout.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING).add(
								jLabel57).add(jLabel56)).addContainerGap(102,
						Short.MAX_VALUE)));
		jPanel40Layout.setVerticalGroup(jPanel40Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel40Layout.createSequentialGroup().add(
						jPanel40Layout.createParallelGroup(
								org.jdesktop.layout.GroupLayout.BASELINE).add(
								savelogscheck).add(jLabel56)).addPreferredGap(
						org.jdesktop.layout.LayoutStyle.RELATED).add(jLabel57)
						.addContainerGap(
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)));

		jPanel37.add(jPanel40,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, 480,
						60));

		jTabbedPane2.addTab("Misc Settings2", jPanel37);

		langcombo.setMaximumRowCount(15);
		langcombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
		...
		jLabel72
				.setText("Select the language you want for the DSHub interface:");

		jLabel59
				.setText("The two small letters is the language code, and the two capitals represent the country code.");

		org.jdesktop.layout.GroupLayout jPanel42Layout = new org.jdesktop.layout.GroupLayout(
				jPanel42);
		...
		jPanel42Layout
				.setVerticalGroup(jPanel42Layout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING)
						.add(
								jPanel42Layout
										...
										.addPreferredGap(
												org.jdesktop.layout.LayoutStyle.RELATED)
										.add(jLabel59).addContainerGap(294,
												Short.MAX_VALUE)));
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(
				...
				jPanel2Layout.createSequentialGroup().addContainerGap().add(
						jTabbedPane2,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 735,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
						.addContainerGap(
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)));
		...
		jLabel11
				.setText("Reg new user by inputing either CID or the nick (if logged in):");

		jTextField1
				.setToolTipText("Enter the CID/Nick(his CID will be added) you want to add");
		...
		jLabel12
				.setText("Note: Registrations are CID only, if you enter a nick, his CID will be added. Press delete on an account to ureg it.");
		...
		AccountTable.setModel(new javax.swing.table.DefaultTableModel(
				...
				}, new String[] { "CID", "Last Nick:", "Last IP:",
						"Regged By:", "Regged At:" }) {
		...
		BanTable
				.setModel(new javax.swing.table.DefaultTableModel(
						...
						}, new String[] { "Type", "Reason", "Who banned",
								"Time Issued", "Nick", "IP", "CID",
								"Remaining time" }) {
					Class[] types = new Class[] { java.lang.Integer.class,
							java.lang.String.class, java.lang.String.class,
							java.lang.String.class, java.lang.String.class,
		...
		jPanel5Layout.setHorizontalGroup(jPanel5Layout.createParallelGroup(
				...
				jPanel5Layout.createSequentialGroup().addContainerGap().add(
						jScrollPane10,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 721,
						Short.MAX_VALUE).addContainerGap()));
		...
		jPanel6Layout.setHorizontalGroup(jPanel6Layout.createParallelGroup(
				...
				jPanel6Layout.createSequentialGroup().addContainerGap().add(
						jScrollPane3,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 731,
						Short.MAX_VALUE)).add(
				jPanel6Layout.createSequentialGroup().add(297, 297, 297).add(
						jButton6,
				...
				.setVerticalGroup(jPanel6Layout
						...
						.add(
								jPanel6Layout
										...
										.addPreferredGap(
												org.jdesktop.layout.LayoutStyle.RELATED)
										.add(jButton6).addContainerGap(139,
												Short.MAX_VALUE)));
		...
		jPanel14Layout.setHorizontalGroup(jPanel14Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel14Layout.createSequentialGroup().addContainerGap().add(
						jPanel14Layout.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING).add(
								jRadioButton1).add(jRadioButton2).add(
								jRadioButton3)).addContainerGap(145,
						Short.MAX_VALUE)));
		jPanel14Layout.setVerticalGroup(jPanel14Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel14Layout.createSequentialGroup().add(jRadioButton1)
						.addPreferredGap(
								org.jdesktop.layout.LayoutStyle.RELATED).add(
								jRadioButton2).addPreferredGap(
								org.jdesktop.layout.LayoutStyle.RELATED).add(
								jRadioButton3).addContainerGap(37,
								Short.MAX_VALUE)));

		jPanel15.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Word Action"));
		...
		jRadioButton4.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
		...
		jRadioButton5.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
		...
		jRadioButton6.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
		...
		jPanel15Layout.setHorizontalGroup(jPanel15Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel15Layout.createSequentialGroup().addContainerGap().add(
						jPanel15Layout.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING).add(
								jTextField3,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
								193, Short.MAX_VALUE).add(jRadioButton4).add(
								jRadioButton5).add(jRadioButton6))
						.addContainerGap()));
		jPanel15Layout.setVerticalGroup(jPanel15Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel15Layout.createSequentialGroup().add(jRadioButton4)
						.addPreferredGap(
								org.jdesktop.layout.LayoutStyle.RELATED).add(
								jRadioButton5).addPreferredGap(
								org.jdesktop.layout.LayoutStyle.RELATED).add(
								jRadioButton6).addPreferredGap(
								org.jdesktop.layout.LayoutStyle.RELATED).add(
								jTextField3,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
		...
		privatecheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
		...
		notifycheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		...
		jPanel16Layout.linkSize(new java.awt.Component[] { jButton26,
				jButton27, jButton28 },
		...
		jPanel16Layout.linkSize(new java.awt.Component[] { jButton29, jLabel63,
				jTextField4 }, org.jdesktop.layout.GroupLayout.VERTICAL);
		...
		jRadioButton7.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
		...
		jRadioButton8.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
		...
		jRadioButton9.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
		...
		jRadioButton10.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
		...
		jRadioButton11.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
		...
		jRadioButton12.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
		...
		jPanel17Layout.linkSize(new java.awt.Component[] { jButton23, jLabel64,
				jTextField2 }, org.jdesktop.layout.GroupLayout.VERTICAL);

		jPanel18.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Forbidden Words List"));
		...
		jPanel18Layout.linkSize(
				new java.awt.Component[] { jButton24, jButton25 },
				org.jdesktop.layout.GroupLayout.HORIZONTAL);
		...
		jPanel9.add(jLabel52,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, -1,
						-1));

		jLabel54.setFont(new java.awt.Font("Tahoma", 0, 10));
		jLabel54.setText("Allowed contexts:");
		jPanel9.add(jLabel54,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 60, -1,
						-1));
		...
		jPanel9.add(jButton13,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, -1,
						-1));
		...
		jPanel9.add(jButton14,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 230, -1,
						-1));
		...
		jPanel9.add(jButton15,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 230, -1,
						-1));
		...
		jPanel9.add(jButton16,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 230, -1,
						-1));
		...
		jPanel9.add(jButton17,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 230, -1,
						-1));
		...
		jPanel9.add(jButton18,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 230, -1,
						-1));
		...
		jPanel9.add(jButton19,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 230, -1,
						-1));
		...
		jPanel9.add(jButton20,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 230, -1,
						-1));
		...
		jPanel9.add(jButton21,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 230, -1,
						-1));

		jPanel25.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				"MSG", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 1, 11))); // NOI18N
		jPanel25.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

		BMSGcheck.setText("B");
		BMSGcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		...
		jPanel25.add(BMSGcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1,
						-1));

		DMSGcheck.setText("D");
		DMSGcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		...
		jPanel25.add(DMSGcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, -1,
						-1));

		EMSGcheck.setText("E");
		EMSGcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		...
		jPanel25.add(EMSGcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1,
						-1));

		FMSGcheck.setText("F");
		FMSGcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		...
		jPanel25.add(FMSGcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1,
						-1));

		HMSGcheck.setText("H");
		HMSGcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		...
		jPanel25.add(HMSGcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1,
						-1));

		jPanel9.add(jPanel25,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, 50,
						130));
		...
		jPanel26.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				"STA", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 1, 11))); // NOI18N
		jPanel26.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

		BSTAcheck.setText("B");
		BSTAcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		...
		jPanel26.add(BSTAcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1,
						-1));

		DSTAcheck.setText("D");
		DSTAcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		...
		jPanel26.add(DSTAcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, -1,
						-1));

		ESTAcheck.setText("E");
		ESTAcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		...
		jPanel26.add(ESTAcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1,
						-1));

		FSTAcheck.setText("F");
		FSTAcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		...
		jPanel26.add(FSTAcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1,
						-1));

		HSTAcheck.setText("H");
		HSTAcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		...
		jPanel26.add(HSTAcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1,
						-1));

		jPanel9.add(jPanel26,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 90, 50,
						130));

		jPanel27.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				"CTM", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 1, 11))); // NOI18N
		jPanel27.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

		BCTMcheck.setText("B");
		BCTMcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		BCTMcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel27.add(BCTMcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1,
						-1));

		DCTMcheck.setText("D");
		DCTMcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		DCTMcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel27.add(DCTMcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, -1,
						-1));

		ECTMcheck.setText("E");
		ECTMcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		ECTMcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel27.add(ECTMcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1,
						-1));

		FCTMcheck.setText("F");
		FCTMcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		FCTMcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel27.add(FCTMcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1,
						-1));

		HCTMcheck.setText("H");
		HCTMcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		HCTMcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel27.add(HCTMcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1,
						-1));

		jPanel9.add(jPanel27,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 90, 50,
						130));

		jPanel28.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				"RCM", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 1, 11))); // NOI18N
		jPanel28.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

		BRCMcheck.setText("B");
		BRCMcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		BRCMcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel28.add(BRCMcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1,
						-1));

		DRCMcheck.setText("D");
		DRCMcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		DRCMcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel28.add(DRCMcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, -1,
						-1));

		ERCMcheck.setText("E");
		ERCMcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		ERCMcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel28.add(ERCMcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1,
						-1));

		FRCMcheck.setText("F");
		FRCMcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		FRCMcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel28.add(FRCMcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1,
						-1));

		HRCMcheck.setText("H");
		HRCMcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		HRCMcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel28.add(HRCMcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1,
						-1));

		jPanel9.add(jPanel28,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 90, 50,
						130));

		jPanel29.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				"INF", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 1, 11))); // NOI18N
		jPanel29.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

		BINFcheck.setText("B");
		BINFcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		BINFcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel29.add(BINFcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1,
						-1));

		DINFcheck.setText("D");
		DINFcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		DINFcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel29.add(DINFcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, -1,
						-1));

		EINFcheck.setText("E");
		EINFcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		EINFcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel29.add(EINFcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1,
						-1));

		FINFcheck.setText("F");
		FINFcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		FINFcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel29.add(FINFcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1,
						-1));

		HINFcheck.setText("H");
		HINFcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		HINFcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel29.add(HINFcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1,
						-1));

		jPanel9.add(jPanel29,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 90, 50,
						130));

		jPanel30.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				"SCH", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 1, 11))); // NOI18N
		jPanel30.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

		BSCHcheck.setText("B");
		BSCHcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		BSCHcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel30.add(BSCHcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1,
						-1));

		DSCHcheck.setText("D");
		DSCHcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		DSCHcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel30.add(DSCHcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, -1,
						-1));

		ESCHcheck.setText("E");
		ESCHcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		ESCHcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel30.add(ESCHcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1,
						-1));

		FSCHcheck.setText("F");
		FSCHcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		FSCHcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel30.add(FSCHcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1,
						-1));

		HSCHcheck.setText("H");
		HSCHcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		HSCHcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel30.add(HSCHcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1,
						-1));

		jPanel9.add(jPanel30,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 90, 50,
						130));

		jPanel31.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				"RES", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 1, 11))); // NOI18N
		jPanel31.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

		BREScheck.setText("B");
		BREScheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		BREScheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel31.add(BREScheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1,
						-1));

		DREScheck.setText("D");
		DREScheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		DREScheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel31.add(DREScheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, -1,
						-1));

		EREScheck.setText("E");
		EREScheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		EREScheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel31.add(EREScheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1,
						-1));

		FREScheck.setText("F");
		FREScheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		FREScheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel31.add(FREScheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1,
						-1));

		HREScheck.setText("H");
		HREScheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		HREScheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel31.add(HREScheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1,
						-1));

		jPanel9.add(jPanel31,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 90, 50,
						130));

		jPanel32.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				"PAS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 1, 11))); // NOI18N
		jPanel32.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

		BPAScheck.setText("B");
		BPAScheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		BPAScheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel32.add(BPAScheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1,
						-1));

		DPAScheck.setText("D");
		DPAScheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		DPAScheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel32.add(DPAScheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, -1,
						-1));

		EPAScheck.setText("E");
		EPAScheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		EPAScheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel32.add(EPAScheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1,
						-1));

		FPAScheck.setText("F");
		FPAScheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		FPAScheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel32.add(FPAScheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1,
						-1));

		HPAScheck.setText("H");
		HPAScheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		HPAScheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel32.add(HPAScheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1,
						-1));

		jPanel9.add(jPanel32,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 90, 50,
						130));

		jPanel33.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				"SUP", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 1, 11))); // NOI18N
		jPanel33.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

		BSUPcheck.setText("B");
		BSUPcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		BSUPcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel33.add(BSUPcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1,
						-1));

		DSUPcheck.setText("D");
		DSUPcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		DSUPcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel33.add(DSUPcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, -1,
						-1));

		ESUPcheck.setText("E");
		ESUPcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		ESUPcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel33.add(ESUPcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1,
						-1));

		FSUPcheck.setText("F");
		FSUPcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		FSUPcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel33.add(FSUPcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1,
						-1));

		HSUPcheck.setText("H");
		HSUPcheck.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0,
				0, 0));
		HSUPcheck.setMargin(new java.awt.Insets(0, 0, 0, 0));
		jPanel33.add(HSUPcheck,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1,
						-1));

		jPanel9.add(jPanel33,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 90, 50,
						130));
		...
		PPanel.add(jScrollPane11,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 720,
						350));
		...
		PPanel.add(jButton30,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 10, 160,
						-1));

		jLabel55
				.setText("Modules are the way DSHub can be extended. Place them in the /modules subdirectory.");
		PPanel.add(jLabel55, new org.netbeans.lib.awtextra.AbsoluteConstraints(
				20, 10, -1, -1));

		jTabbedPane1.addTab("Additional Modules", PPanel);

		jLabel58
				.setText("The DSHub scripts and the scripting languages currently supported. Scripts path: /scripts .");
		...
		jPanel41.add(jScrollPane1,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 30, 570,
						290));

		jLabel60.setText("Relative path: /py");
		jPanel41.add(jLabel60,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, -1,
						-1));
		...
		jPanel22Layout.setVerticalGroup(jPanel22Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel22Layout.createSequentialGroup().addContainerGap().add(
						jPanel22Layout.createParallelGroup(
								org.jdesktop.layout.GroupLayout.BASELINE).add(
								jLabel58).add(jButton32)).addPreferredGap(
						org.jdesktop.layout.LayoutStyle.UNRELATED).add(
						jTabbedPane3,
		...
		jPanel12Layout.setHorizontalGroup(jPanel12Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				org.jdesktop.layout.GroupLayout.TRAILING,
				jPanel12Layout.createSequentialGroup().addContainerGap().add(
						jScrollPane4,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 721,
						Short.MAX_VALUE).addContainerGap()));
		...
		jPanel4Layout.setHorizontalGroup(jPanel4Layout.createParallelGroup(
				...
				jPanel4Layout.createSequentialGroup().addContainerGap().add(
						Panelxxx, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						721, Short.MAX_VALUE).addContainerGap()));
		jPanel4Layout.setVerticalGroup(jPanel4Layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				jPanel4Layout.createSequentialGroup().add(Panelxxx,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 318,
						org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
	...
	// TODO add your handling code here:
		...
		listaBanate.modifyMultiPrAt(jList1.getSelectedIndices(), prop
				...
				+ (privatecheck.isSelected() ? BannedWord.privatechat : 0)
				+ (searchcheck.isSelected() ? BannedWord.searches : 0));
