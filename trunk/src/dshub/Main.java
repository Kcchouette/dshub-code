        ...
        else if (recvbuf.toLowerCase ().startsWith("cfg"))
        {
                ...
                else if(aux.toLowerCase ().equals ("list"))
                {
                    System.out.println(Translation.getString("cfg_list")+": \n"+
                            ...
                            +          "   redirect_url              "  + Vars.redirect_url+ "         -- "+Translation.getString("redirect_url")+"\n"
                            +          "   max_ni                  "  +Vars.max_ni+" -- "+Translation.getString("max_ni")+"\n"
                            +          "   min_ni                  "  +Vars.min_ni+" -- "+Translation.getString("min_ni")+"\n"
                            +          "   max_de                  "  +Vars.max_de+" -- "+Translation.getString("max_de")+"\n"
                            +          "   max_share               "  +Vars.max_share+" -- "+Translation.getString("max_share")+"\n"
                            +          "   min_share               "  +Vars.min_share+" -- "+Translation.getString("min_share")+"\n"
                            +          "   max_sl                  "  +Vars.max_sl+" -- "+Translation.getString("max_sl")+"\n"
                            +          "   min_sl                  "  +Vars.min_sl+" -- "+Translation.getString("min_sl")+"\n"
                            +          "   max_em                  "  +Vars.max_em+" -- "+Translation.getString("max_em")+"\n"
                            +          "   max_hubs_op             "  +Vars.max_hubs_op+" -- "+Translation.getString("max_hubs_op")+"\n"
                            +          "   max_hubs_reg            "  +Vars.max_hubs_reg+" -- "+Translation.getString("max_hubs_reg")+"\n"
                            +          "   max_hubs_user           "  +Vars.max_hubs_user+" -- "+Translation.getString("max_hubs_user")+"\n"
                            +          "   max_sch_chars           "  +Vars.max_sch_chars+" -- "+Translation.getString("max_search_chars")+"\n"
                            +          "   min_sch_chars           "  +Vars.min_sch_chars+" -- "+Translation.getString("min_search_chars")+"\n"
                            +          "   max_chat_msg            "  +Vars.max_chat_msg+" -- "+Translation.getString("max_chat_msg")+"\n"
                            +          "   max_users               "  +Vars.max_users+" -- "+Translation.getString("max_users")+"\n"
