...
find *.java *.form *.jpg *.xml *.properties *.jar *.sh *.html *.css *.gif readme.txt license.txt LICENSE.slf4j.txt mina-license.txt LICENSE.jzlib.txt changelog.txt nbproject src lib javadoc manifest.mf build.xml \
